# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/petunjuk_arah_page.xml',
        'views/privacy_policy.xml',
        'views/shop_operating_hours.xml',
        'views/shop_filter_chips.xml',
        'views/cron_business_hours.xml',
        'views/pickup_mode_redesign.xml',
        'views/payment_delivery_redesign.xml',
        'views/product_terms_cleanup.xml',
    ],
    'license': 'LGPL-3',
}
